...
(define (add-set elem set) (judge-reduce set elem (lambda (x y) (not (equal? x y))) cons (cons elem `())))
(define (interaction s1 s2) (judge-reduce s1 s2 member (lambda (x y) (+ 1 y)) 0))
